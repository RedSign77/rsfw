...
class Core extends Singleton
{
    ...
    {
        $special = array('ö', 'ü', 'ó', 'ő', 'ú', 'é', 'á', 'ű', 'í', 'Ö', 'Ü', 'Ó', 'Ő', 'Ú', 'É', 'Á', 'Ű', 'Í');
        $changed = array('o', 'u', 'o', 'o', 'u', 'e', 'a', 'u', 'i', 'O', 'O', 'O', 'O', 'U', 'E', 'A', 'U', 'I');
     ...
     * @return string
     */
    public static function debug(&$type, $file = null, $line = null)
    {
        $ret = "";
        $ret .= "<pre>";
